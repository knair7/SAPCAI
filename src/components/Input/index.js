...
import './style.scss'
import FileChooser from '../../componentsEx/FileChooser'
import Voice from '../../componentsEx/Voice'
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {this.props.fileDrop ? <FileChooser onSubmit={this.props.onSubmit} /> : null}
        {this.props.voice ? <Voice onSubmit={this.props.onSubmit} /> : null}
        {showLimitCharacter && (
